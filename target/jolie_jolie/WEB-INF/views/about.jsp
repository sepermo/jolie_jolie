...
<head>
    ...
    <link rel="stylesheet" href="resources/css/estilos_acerca_de.css">
...
<body>  
    ...
    <header>
        ...
        <div class="container">
            ...
            <br>
            <div class="caja2"><p>Jolie Jolie nace en 2020 como una respuesta a la necesidad de ofrecer un producto diferenciado, un producto en donde los detalles, las texturas y acabados brinden una experiencia &#250nica a todos nuestros clientes.</p></div>
            <br><br>
            <div class="caja1"><h2>NUESTRO ESP&#205RITU</h2></div>
            <br>
            <div class="caja2"><p>El esp&#237ritu de Jolie Jolie es femenino, fresco y creativo y tiene como objetivo sorprender al mercado con cada una de sus creaciones.</p></div>
        </div>  
    <!--fin box contactame-->
      <!--inicio footer-->
      <footer>
